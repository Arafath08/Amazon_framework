...
public class TestUtility extends TestBase
{
	...
	public static boolean DisplayedElement1(WebDriver driver2, WebElement locator) {
		// TODO Auto-generated method stub
		try {
		 WebElement eleimg = locator;
		  if(eleimg.isDisplayed()) {
			    System.out.println("Element is displayed");
		return false;
	}
		  else {
			  System.out.println("Element is not displayed");
			  return false; //element is present,but it is hidden
		  }
